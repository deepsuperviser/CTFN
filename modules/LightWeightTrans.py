...
class EmotionClassifier(nn.Module):
    def __init__(self, config):
        ...
        self.rnn_text = nn.LSTM(input_size=config.text_dim, hidden_size=config.gru_units,
                                num_layers=1, bidirectional=False, dropout=0.0)
        self.rnn_audio = nn.LSTM(input_size=config.audio_dim, hidden_size=config.gru_units,
                                 num_layers=1, bidirectional=False, dropout=0.0)
